<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockSelect.aspx.cs" Inherits="WebProject.StockSelect" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" id="h1text">재고 조회</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <!-- /.col-lg-8 -->
                    ...
                    <div class="panel panel-default"> 
                        ...
                        <div class="panel-body">
                            <!-- /.list-group -->
                            &nbsp;
                            <asp:GridView ID="stockGridview" runat="server" CellPadding="7" Width="100%"  AllowPaging="True" OnPageIndexChanged="stockGridview_PageIndexChanged">
